...
reply_markup: {
inline_keyboard: [
[{ text: 'BotWa', url: 'wa.me/62831745089627'}
],
[
...
async function help(anu) {
    ...
    options = {
        reply_markup: {
            inline_keyboard: [
            	[
					{ text: 'Bot WhatsApp', url: 'wa.me/62831745089627'},
				    { text: 'Tutorial Penggunaan', url: 'https://youtu.be/yflsTEy_LH4'}
				],
                [
...
if (!q) return client.reply(`masukan url\ncontoh ketik : ${prefix}tiktok <link>`)
           ...
           try {
				...
				let nih = `TIKTOK DOWNLOADER BY BOTZZMEE
				`
